...
class newEvent {
    ...
    pricerange;
    availableTickets;
    constructor(title, date, price, ticket) {
        this.title = title,
            this.date = date,
...
class Event {
    ...
    availableTickets;
    ticketsLeft;
    constructor(name, time, city, tickets, ticketleft) {
        this.title = name;
        this.time = time;
        this.city = city;
    ...
    purchaseTicket(ticketbought) {
        if (ticketbought > 100) {
            ...
            console.log(chalk.greenBright(`Congrats! You have successfully secured ${ticketbought} tickets for ${this.title}!`));
        }
    }
    remainingTickets() {
...
console.log(chalk.bold.blueBright("Welcome to the Online Ticketing Platform!"));
let createevent = [];
async function info() {
    let emailInfo = {};
    ...
    while (!exit) {
        ...
        if ((userInfo.options === "User")) {
            ...
            if (loggedInUser) {
                ...
                else if (userOptions.choices === "My Purchased Tickets") {
                ...
                if (admin) {
                    ...
                    if (adminActions.chooseAction === "Create event") {
                        ...
                        while (condition) {
                            ...
                            let addevent = { title: createevents.title,
